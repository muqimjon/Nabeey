...
public class AnswerService : IAnswerService
{
    ...
    {
        Answer answer = await this.repository.SelectAsync(x => x.Id.Equals(dto.Id), includes: new[] { "Question", "Asset" })
    ...
    {
        Answer existAnswer = await this.repository.SelectAsync(x => x.Id.Equals(id), includes: new[] { "Question", "Asset" })
